...
class _$_InsufficientPermission implements _InsufficientPermission {
  ...
  @override
  String toString() {
    return 'ArticleFailure.insufficientPermission()';
  }
...
abstract class _InsufficientPermission implements ArticleFailure {
...
class _$_UnableToUpdate implements _UnableToUpdate {
  ...
  @override
  String toString() {
    return 'ArticleFailure.unableToUpdate()';
  }
...
abstract class _UnableToUpdate implements ArticleFailure {
